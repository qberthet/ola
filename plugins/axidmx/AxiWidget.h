...
#ifndef PLUGINS_AXIDMX_AXIWIDGET_H_
#define PLUGINS_AXIDMX_AXIWIDGET_H_
...
/**
 * An AXI widget (i.e. a serial port with suitable hardware attached)
 */
class AxiWidget {
 public:
    /**
     * Construct a new AxiWidget instance for one widget.
     * @param path The device file path of the serial port
     */
    explicit AxiWidget(const std::string &path);
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(AxiWidget);
};
}  // namespace axidmx
}  // namespace plugin
}  // namespace ola
#endif  // PLUGINS_AXIDMX_AXIWIDGET_H_
